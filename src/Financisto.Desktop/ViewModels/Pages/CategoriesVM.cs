...
namespace Financisto.Desktop.ViewModels.Pages
{
    ...
    public class CategoriesVM : EntityBaseVM<CategoryTreeModel>
    {
        ...
        public CategoriesVM(IFinancistoDatabase db, IDialogWrapper dialogWrapper)
        ...
        private async Task OpenCategoryDialogAsync(int id)
        {
            ...
            var result = await dialogWrapper.ShowDialogAsync<CategoryControl>(vm, 300, 400, LocalizationService.Instance.category);
