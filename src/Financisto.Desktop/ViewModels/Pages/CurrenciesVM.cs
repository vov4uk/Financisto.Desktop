...
namespace Financisto.Desktop.ViewModels.Pages
{
    ...
    public class CurrenciesVM : EntityBaseVM<CurrencyModel>
    {
        ...
        public CurrenciesVM(IFinancistoDatabase db, IDialogWrapper dialogWrapper)
        ...
        protected override async Task OnAdd()
        {
            ...
            var selection = await dialogWrapper.ShowDialogAsync<AddCurrencyControl>(addVm, 400, 340, LocalizationService.Instance.currencies)
        ...
        private async Task OpenCurrencyDialogAsync(int id)
        {
            ...
            var result = await dialogWrapper.ShowDialogAsync<CurrencyControl>(vm, 340, 440, LocalizationService.Instance.currency);
